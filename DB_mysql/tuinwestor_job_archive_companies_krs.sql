...
--
-- Table structure for table `job_archive_companies_krs`
--

DROP TABLE IF EXISTS `job_archive_companies_krs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `job_archive_companies_krs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `comp_id` int DEFAULT NULL,
  `name_search` varchar(100) DEFAULT NULL,
  `krs` varchar(11) DEFAULT NULL,
...
-- Dump completed on 2022-07-20 13:32:45
